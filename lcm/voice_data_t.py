...
class voice_data_t(object):
    __slots__ = ["source_id", "destination_id", "data_size", "data"]
    ...
    def __init__(self):
        ...
        self.data_size = 0
        self.data = [ 0 for dim0 in range(512-4-2-2-2) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>512-4-2-2-2b', *self.data[:512-4-2-2-2]))
    ...
    def _decode_one(buf):
        ...
        self.data = struct.unpack('>512-4-2-2-2b', buf.read(512))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc94309bc34b62ba0) & 0xffffffffffffffff
